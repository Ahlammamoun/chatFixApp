...
final class Version20251031155156 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE IF NOT EXISTS rating (id INT AUTO_INCREMENT NOT NULL, rating_id INT DEFAULT NULL, user_id INT DEFAULT NULL, value DOUBLE PRECISION DEFAULT NULL, INDEX IDX_D8892622A32EFC6 (rating_id), INDEX IDX_D8892622A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
